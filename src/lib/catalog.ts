...
export const SEED_RECIPES: Recipe[] = [
  ...
  rec("r-tue", "Tuétanos (orden de 2)", "entrada", 140, [L("tue", 2), L("lim", 1), L("ceb", 0.05)]),
  ...
  rec("r-arr-12", "1/2 kg de arrachera", "corte", 400, [L("arr", 0.5), beans, salsa]),
...
export const MENU_SECTIONS: MenuSection[] = [
  {
    ...
    items: [
      ...
      { name: "Tuétanos", desc: "Orden de 2 piezas", price: 140, recipeId: "r-tue" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "1/2 kg de arrachera", price: 400, recipeId: "r-arr-12" },
